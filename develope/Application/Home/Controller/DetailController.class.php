	...
	class DetailController extends Controller
	{
		public function index(){
			if(Cookie("student_id")) {
				...
				$Student_id = Cookie('student_id');    //接收学生的ID

				$coo['content_id'] = $Content_id;
				$coo['student_id'] = $Student_id;
				$this->assign("content_id", $coo['content_id']);
				$this->assign("student_id", $coo['student_id']);
